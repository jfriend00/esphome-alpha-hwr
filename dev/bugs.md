...
- https://github.com/christoph2/GENIBus/blob/master/src/genibus/gbdefs.py defines the operation codes (GET = 0, SET = 2, INFO = 3) and the acknowledge codes (OK = 0, plus the error codes). This is where you can confirm that 0xC1 decodes to INFO and 0x81 to SET.
